...
const FoodAnalysisView = ({ dateFilter = {}, onOpenFoodGuide }) => {
    ...
    const automaticTrendModel = useMemo(
        ...
        [receipts, products, productAliases, foodClassificationOverrides, dynamicWindowSize]
    );
    ...
    }, [analysisReferenceDate, foodClassificationOverrides, productAliases, filteredProducts, filteredReceipts, automaticTrendModel.monthlySeries, dynamicWindowSize]);
