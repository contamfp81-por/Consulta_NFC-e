...
const ForecastPrecisionContent = ({
    ...
    return (
        <div className="animate-slide-up" style={{ display: 'grid', gap: '22px', width: '100%', minWidth: 0 }}>
            ...
            {validation.alertMessage && (
                <div className="glass-card" style={{ marginBottom: 0, border: '1px solid rgba(239, 68, 68, 0.22)', background: 'rgba(43, 17, 24, 0.72)' }}>
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', color: '#FCA5A5' }}>
                        <AlertTriangle size={18} style={{ flexShrink: 0, marginTop: '2px' }} />
                        <div style={{ fontSize: '0.84rem', lineHeight: 1.55, color: '#FECACA' }}>
    ...
    return (
        <button
            ...
            style={{
                ...
                background: `linear-gradient(135deg, ${validation.status.color}14 0%, rgba(8, 19, 31, 0.92) 100%)`
            }}
        >
            <div>
