    ...
    const handleQRCodeDecoded = async (url) => {
        ...
        try {
            ...
            if (data.products && data.products.length > 0) {
                ...
                // Caso o robô falhe em ler os produtos, ainda salvamos o recibo como "parcial"
                setStatus('success');
                console.warn("Robô salvou apenas o cabeçalho (produtos não encontrados).");
            }
            ...
            setStatus('error');
            setErrorMessage('O Robô falhou ao processar este cupom. Verifique sua conexão ou tente outro cupom.');
        }
    };
