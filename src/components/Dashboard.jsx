...
const Dashboard = () => {
    ...
    return (
        <div className="animate-slide-up" style={{ paddingBottom: '20px' }}>
            ...
            <div className="glass-card" style={{ marginBottom: '25px', padding: '18px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '10px', flexWrap: 'wrap', marginBottom: '12px' }}>
                    ...
                    <div style={{ fontSize: '0.76rem', color: 'var(--text-light)' }}>
                        Periodo aplicado: {selectedPeriodLabel}
                    </div>
                </div>
                <div
                    style={{
                ...
                >
                    <div style={{ fontSize: '0.72rem', color: 'var(--text-light)', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                        Base disponivel
                    </div>
            ...
            {currentMonthProjectionCard}

            {hasFilteredResults ? (
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '20px' }}>
                <CardCarouselItem index={0} currentIndex={currentCardIndex}>{/* 1. Evolução de Preço por Produto */}
                ...
                </CardCarouselItem><CardCarouselItem index={1} currentIndex={currentCardIndex}>{/* NOVO: Evolução dos Gastos ao longo do tempo (Somatório global) */}
                ...
                </CardCarouselItem><CardCarouselItem index={2} currentIndex={currentCardIndex}>{/* 1 & 2: Pizza e Barras - Lojas */}
                <div style={RESPONSIVE_CARD_GRID}>
                ...
                </CardCarouselItem><CardCarouselItem index={3} currentIndex={currentCardIndex}>{/* 4 & 5: Empilhadas e Área */}
                <div style={RESPONSIVE_CARD_GRID}>
                ...
                </CardCarouselItem><CardCarouselItem index={4} currentIndex={currentCardIndex}>{/* 6: Pareto */}
                ...
                </CardCarouselItem><CardCarouselItem index={5} currentIndex={currentCardIndex}>{/* 7: Treemap */}
                ...
                </CardCarouselItem><CardCarouselItem index={6} currentIndex={currentCardIndex}>{/* Categorias e Histograma */}
                <div style={RESPONSIVE_CARD_GRID}>
                    <ChartCard title="Gastos por Categoria (%)" icon={BarChart3} contentHeight={`${Math.min(520, Math.max(250, stats.categorySpendData.length * 36))}px`}>
                        <ResponsiveContainer width="100%" height="100%">
                ...
                <div
                    </CardCarouselItem><CardCarouselItem index={7} currentIndex={currentCardIndex}>className="glass-card"
                    style={{
                        display: 'flex',
                        flexDirection: 'column',
                        maxHeight: MAX_CARD_VIEWPORT_HEIGHT,
                ...
                </CardCarouselItem><CardCarouselItem index={8} currentIndex={currentCardIndex}>{/* 10: Heatmap (Weekday) */}
                ...
                <div
                    </CardCarouselItem><CardCarouselItem index={9} currentIndex={currentCardIndex}>className="glass-card"
                    style={{
                        display: 'flex',
                        flexDirection: 'column',
                        maxHeight: MAX_CARD_VIEWPORT_HEIGHT,
                ...
                </CardCarouselItem><CardCarouselItem index={10} currentIndex={currentCardIndex}>{/* Top Produtos Recorrentes Card - Penultimo Card */}
                ...
                </CardCarouselItem><CardCarouselItem index={11} currentIndex={currentCardIndex}>{/* Report Export Subsystem Card - Último Card */}
                {exportReportCard}</CardCarouselItem>

            </div>
            
                {/* Navegador entre cards */}
                <div style={{ position: 'fixed', bottom: '90px', left: '20px', right: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 1000, pointerEvents: 'none' }}>
                    <button 
                        onClick={(e) => { e.stopPropagation(); setCurrentCardIndex(prev => Math.max(0, prev - 1)); window.scrollTo({top: 0, behavior: 'smooth'}); }}
                        disabled={currentCardIndex === 0}
                        style={{ pointerEvents: 'auto', background: 'var(--primary-blue)', color: 'white', border: 'none', borderRadius: '50%', width: '55px', height: '55px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 15px rgba(26, 35, 126, 0.4)', opacity: currentCardIndex === 0 ? 0.4 : 1, transition: 'all 0.3s ease' }}
                    >
                        <ChevronLeft size={28} />
                    </button>
                    <div style={{ pointerEvents: 'auto', background: 'rgba(255, 255, 255, 0.95)', padding: '8px 16px', borderRadius: '25px', fontSize: '0.85rem', fontWeight: 700, color: 'var(--primary-blue)', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(26, 35, 126, 0.1)' }}>
                        {currentCardIndex + 1} / 12
                    </div>
                    <button 
                        onClick={(e) => { e.stopPropagation(); setCurrentCardIndex(prev => Math.min(11, prev + 1)); window.scrollTo({top: 0, behavior: 'smooth'}); }}
                        disabled={currentCardIndex === 11}
                        style={{ pointerEvents: 'auto', background: 'var(--primary-blue)', color: 'white', border: 'none', borderRadius: '50%', width: '55px', height: '55px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 15px rgba(26, 35, 126, 0.4)', opacity: currentCardIndex === 11 ? 0.4 : 1, transition: 'all 0.3s ease' }}
                    >
