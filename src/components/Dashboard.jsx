        ...
        <div className="animate-slide-up" style={{ paddingBottom: '20px' }}>
            ...
            <>
                ...
                <div style={{ padding: '30px 0', display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', maxWidth: '500px', margin: '0 auto' }}>
                    ...
                    <button 
                        onClick={(e) => { e.stopPropagation(); setCurrentCardIndex(prev => Math.min(14, prev + 1)); }}
                        disabled={currentCardIndex === 14}
                        style={{ background: 'var(--primary-blue)', color: 'white', border: 'none', borderRadius: '50%', width: '55px', height: '55px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 15px rgba(26, 35, 126, 0.4)', opacity: currentCardIndex === 14 ? 0.4 : 1, transition: 'all 0.3s ease', cursor: 'pointer' }}
                    >
