...
const Dashboard = () => {
    ...
    const currentMonthInsight = useMemo(() => {
        ...
        return {
            ...
            algorithmWeights: forecastCore?.weights || forecastModelConfig.weights,
            componentRates: forecastCore?.componentRates || null,
            weightedComponents: forecastCore?.weightedComponents || null
        };
    ...
    useEffect(() => {
        ...
        if (
            ...
            || forecastModelConfig.lastRecalibratedAt === recalibrationDateKey
        ) {
            return;
        }
        ...
        db.forecastModelConfigs.put({
            ...
            lastRecalibratedAt: recalibrationDateKey,
            updatedAt: new Date().toISOString()
        });
