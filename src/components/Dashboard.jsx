...
const Dashboard = () => {
    ...
    return (
        <div className="animate-slide-up" style={{ paddingBottom: '20px' }}>
            ...
            {hasFilteredResults && (
                <div style={RESPONSIVE_CARD_GRID} className="animate-slide-up">
                    {/* Top Produtos Recorrentes Card */}
                    <ChartCard title="Top 5 Produtos Mais Recorrentes" icon={ShoppingBag} contentHeight="auto">
