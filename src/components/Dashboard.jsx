    ...
    return (
        <div className="animate-slide-up" style={{ paddingBottom: '20px' }}>
            ...
            <>
                ...
                {/* 9. Histograma de preços */}
                
                    {/* Excluded from carousel flow */} <div style={{display: "none"}}><ChartCard title="Gastos por Categoria (%)" icon={BarChart3} contentHeight={`${Math.min(520, Math.max(250, stats.categorySpendData.length * 36))}px`}>
                        <ResponsiveContainer width="100%" height="100%">
                    ...
                    </CardCarouselItem><CardCarouselItem index={9} currentIndex={currentCardIndex}><ChartCard title="Histograma de Preços" icon={Hash}>
                        <ResponsiveContainer width="100%" height="100%">
                ...
                </CardCarouselItem><CardCarouselItem index={10} currentIndex={currentCardIndex}><div className="glass-card"
                    style={{
                        display: 'flex',
                        flexDirection: 'column',
                        maxHeight: MAX_CARD_VIEWPORT_HEIGHT,
                ...
                </CardCarouselItem><CardCarouselItem index={11} currentIndex={currentCardIndex}>{/* 11. Mapa de calor */}
                ...
                </CardCarouselItem><CardCarouselItem index={12} currentIndex={currentCardIndex}><div className="glass-card"
                    style={{
                        display: 'flex',
                        flexDirection: 'column',
                        maxHeight: MAX_CARD_VIEWPORT_HEIGHT,
                ...
                </CardCarouselItem><CardCarouselItem index={13} currentIndex={currentCardIndex}>{/* 13. Top 5 produtos recorrentes */}
                ...
                </CardCarouselItem><CardCarouselItem index={14} currentIndex={currentCardIndex}>{/* 14. Exportação */}
                ...
                <div style={{ position: 'fixed', bottom: '90px', left: '20px', right: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 1000, pointerEvents: 'none' }}>
                    ...
                    <div style={{ pointerEvents: 'auto', background: 'rgba(255, 255, 255, 0.95)', padding: '8px 16px', borderRadius: '25px', fontSize: '0.85rem', fontWeight: 700, color: 'var(--primary-blue)', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(26, 35, 126, 0.1)' }}>
                        {currentCardIndex + 1} / 15
                    </div>
                    <button 
                        onClick={(e) => { e.stopPropagation(); setCurrentCardIndex(prev => Math.min(14, prev + 1)); window.scrollTo({top: 0, behavior: 'smooth'}); }}
                        disabled={currentCardIndex === 14}
                        style={{ pointerEvents: 'auto', background: 'var(--primary-blue)', color: 'white', border: 'none', borderRadius: '50%', width: '55px', height: '55px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 15px rgba(26, 35, 126, 0.4)', opacity: currentCardIndex === 14 ? 0.4 : 1, transition: 'all 0.3s ease' }}
                    >
