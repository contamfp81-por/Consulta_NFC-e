            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                                            ...
                                            <div key={product.id} style={{ fontSize: '0.85rem' }}>
                                                ...
                                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '4px' }}>
                                                    ...
                                                    <select
                                                        ...
                                                        style={{ fontSize: '0.7rem', padding: '2px 5px', borderRadius: '5px', border: '1px solid #ddd' }}
                                                    >
                ...
                {receipts.length === 0 && (
                    <div style={{ textAlign: 'center', padding: '40px 20px', color: 'var(--text-light)' }}>
                        ...
                        <p>Nenhum cupom importado ainda.</p>
                        <p style={{ fontSize: '0.8rem' }}>Clique em "Escanear" para começar.</p>
                    </div>
                )}
            </div>
        </div>
