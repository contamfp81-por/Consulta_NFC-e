...
import { db } from '../db';
import { formatCompactCurrency, summarizeReceiptsByOrigin } from '../utils/financeInsights';
import {
...
const ReportsView = ({ onOpenPlanning, onOpenFoodGuide }) => {
        ...
        <div className="screen-stack">
            <MotionSection {...sectionTransition} className="page-intro-card">
                ...
                <div className="info-strip-grid">
                    ...
                    <div className="info-strip">
                        <BarChart3 size={16} />
                        <span>{scopedProducts.length} itens detalhados no intervalo</span>
                    </div>
                    <div className="info-strip">
                        <History size={16} />
