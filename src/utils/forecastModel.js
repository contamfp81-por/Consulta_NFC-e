...
const buildBehaviorSignal = ({ entries, behaviorConfig }) => {
    ...
    let label = 'Estavel';
    let description = 'O comportamento recente segue proximo da media historica e mantem os pesos centrais do modelo.';

    if (factor >= 1.08) {
        label = 'Pressao de alta';
        description = 'Os ultimos 3 dias ficaram acima da base de 30 dias e puxam a previsao para cima.';
    } else if (factor <= 0.92) {
        label = 'Descompressao';
        description = 'Os ultimos 3 dias recuaram frente ao historico de 30 dias e reduzem a previsao base.';
    }
